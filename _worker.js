			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						// For any other path, reverse proxy to 'www.taobao.com' and return the original response, caching it in the process
						const hostnames = ['www.taobao.com', 'www.toutiao.com', 'www.huya.com', 'tv.cctv.com', 'www.bilibili.com/', 'v.qq.com', 'i.youku.com', 'weibo.com'];
